                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card-footer">
                                                <center><h1><?php echo ucfirst(htmlspecialchars(explode(' ', $row['first_name'])[0])); ?></h1></center>
                                                <div class="row">
...
<div class="modal fade" id="addEmployeeModal" tabindex="-1" aria-labelledby="addEmployeeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="save_employees.php" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3 text-center">
                                <div class="profile-picture">
                                    <img id="profilePreview" src="emp_profile/default.jpg" alt="Profile Picture" class="rounded-circle" width="100" height="100">
                                </div>
                                <input type="file" class="form-control mt-2" name="employeePhoto" id="employeePhoto" accept="image/*" required>
                            </div>
        ...
        <script>
            ...
            document.getElementById('employeePhoto').addEventListener('change', function(event) {
